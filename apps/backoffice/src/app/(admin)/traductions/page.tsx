...
export default async function Traductions({
  ...
  return (
    <>
      <PageHeader
        title="Traductions"
        description="Une carte non traduite est servie en français dans l’app en anglais."
        actions={<ButtonLink href="/api/export/cards" icon={<DownloadSimpleIcon aria-hidden />}>Export CSV</ButtonLink>}
      />
